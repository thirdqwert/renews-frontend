    ...
    return (
        <div className="pb-[20px]">
            <div className="flex flex-row flex-wrap gap-[10px] border-gray-400">
                ...
                <button onClick={() => editor.chain().focus().setParagraph().run()} className={`tiptap_button`}>
                    Paragraph
                </button>

                <button onClick={() => editor.chain().focus().toggleBold().run()} className={`tiptap_button`}>
                    Bold
                </button>

                <button onClick={() => editor.chain().focus().toggleItalic().run()} className={`tiptap_button`}>
                    Italic
                </button>

                <button onClick={() => editor.chain().focus().toggleStrike().run()} className={`tiptap_button`}>
                    Strike
                </button>

                <button onClick={() => editor.chain().focus().toggleHighlight().run()} className={`tiptap_button`}>
                    Highlight
                </button>
                ...
                <button onClick={() => editor.chain().focus().toggleBlockquote().run()} className="tiptap_button">
                    Toggle blockquote
                </button>
                <button onClick={() => editor.chain().focus().setBlockquote().run()} className="tiptap_button">
                    Set blockquote
                </button>
                <button onClick={() => editor.chain().focus().unsetBlockquote().run()} className="tiptap_button">
                    Unset blockquote
                </button>
                <button
                    onClick={() => {
