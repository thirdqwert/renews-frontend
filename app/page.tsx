...
export const metadata: Metadata = {
    ...
    description:
        "Renews — читайте последние новости Узбекистана: политика, спорт, культура, экономика. Горячие новости и популярное за неделю.",
            ...
            <main className="py-[30px]">
                <div className="container">
                    ...
                    <section className="pb-[30px] md:pb-[70px]">
                        <h2 className="font-bold md:text-[24px] xl:text-[30px] font-bold text-[#222] text-center pb-[30px]">
                            Новости
                        </h2>
                                        ...
                                        >
                                            <article className="w-full">
                                                ...
                                                <div className="flex flex-col">
                                                    <h3 className="mb-[15px] text-[#212529] text-[14px] md:text-[30px] font-bold short_desc">
                                                        {politics_news[0].title}
                                                    </h3>
                                                    <p className="text-[#495057] text-[13px] md:text-[24px] font-medium long_desc">
                                                        {politics_news[0].desc}
                                                    </p>
                                                </div>
                                            </article>
                                        </Link>
