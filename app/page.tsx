            ...
            <main>
                <div className="container">
                        ...
                        <div>
                            <div className="news__1_parent mb-[30px]">
                                <div className="news__1_div1">
                                    <Link href={`news/${politics_news[0].id}/`}>
                                        <article className="w-full">
                                            <div className="relative rounded-[10px] overflow-hidden">
                                                ...
                                                <Image unoptimized width={0} height={0} className="w-full h-[500px] object-cover" src={politics_news[0].preview} alt={politics_news[0].title} />
                                            ...
                                            <div className="flex flex-col">
                                                <h3 className="my-[35px] text-[#212529] text-[30px] font-bold leading-[normal] short_desc">{politics_news[0].title}</h3>
                    ...
                    <section className="pt-[100px]">
                        ...
                        <HorizontalCardList list={news.slice(0, 3)} />
                        <Link href={'/news/'} className="text-[20px] px-[17px] py-[7px] mx-auto mt-[60px] block w-max bg-[#343a40] rounded-[20px] text-white">Показать еще</Link>
                    </section>
                </div >
            </main >
